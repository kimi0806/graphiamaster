...
<body class="hold-transition sidebar-collapse layout-top-nav">
  ...
  <div class="wrapper">
        ...
        <div class="container">
          <div class="row mb-2">
            <div class="col-sm-6">
              ...
              echo $view->activity_name($_GET['activity_id']);
              ?>
              Items
              </h1>
            </div><!-- /.col -->
                ...
                <div class="card-header" style="padding-top: 5px; padding-bottom: 5px;">
                  <div class="row">
                    <div class="col-sm-9 col-lg-10 d-flex align-items-center">
                      ...
                      echo $view->student_name($_GET['student_id']);
                      ?>
                    </div>
                      <?php  
                      $obj = new Controller;
                      ...
                      $view = $obj->view('ActivitiesView');
                      echo $view->get_again_activity_id($_GET['activity_id']);
                      ?>
                  </div>
                </div>
                <div class="card-body">
                  <div class="table-responsive">
                    ...
                    echo $view->my_activities($_GET['student_id'], $_GET['activity_id'], 'Active');
                    ?>
                  </div>
                </div>
                <!-- /.card-body -->
    ...
    $view = $obj->view('StudentActivitiesView');
    echo $view->activity_item_info_mdl($_GET['student_id'], $_GET['activity_id'], 'Active');
    ?>

    <?php  
    $obj = new Controller;

    $view = $obj->view('StudentActivityPointsView');
    echo $view->activity_evaluation();
    ?>
