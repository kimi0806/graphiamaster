                ...
                <div class="card-header" style="padding-top: 5px; padding-bottom: 5px;">
                  <div class="row">
                    <div class="col-sm-9 col-lg-10 d-flex align-items-center">
                      <h5 class="card-title p-1">List Activities</h5>
                    ...
                    <!-- <div class="col-sm-3 col-lg-2">
                      <a href="per_students.php" class="btn btn-block btn-info btn-sm w-100"><i class="fas fa-arrow-left fa-md"></i> Back</a>
                    </div> -->
                  </div>
                </div>
                <div class="card-body">
                  <div class="table-responsive">
                    ...
                    echo $view->activities_per_lesson($teacher_user_id, $_GET['lesson_id'], 'Active');
                    ?>
                  </div>
                </div>
                <!-- /.card-body -->
