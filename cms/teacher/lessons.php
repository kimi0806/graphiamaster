...
<body class="hold-transition sidebar-collapse layout-top-nav">
  <div class="wrapper">
                ...
                <div class="card-header" style="padding-top: 5px; padding-bottom: 5px;">
                  <div class="row">
                    <div class="col-sm-9 col-lg-10 d-flex align-items-center">
                      <h5 class="card-title text-muted p-2">List of Lessons</h5>
                    </div>
                    <div class="col-sm-3 col-lg-2">
                      <a href="new_lesson.php" class="btn btn-block btn-success w-100"><i class="fas fa-plus fa-md"></i> New Lesson</a>
                    </div>
                  </div>
                </div>
                <div class="card-body">
                  <div class="table-responsive">
                    ...
                    echo $view->list_of_category_lessons($user_id, 'Active');
                    ?>
                  </div>
                </div>
                <!-- /.card-body -->
    ...
    $view = $obj->view('LessonsView');
    echo $view->mdl_category_lesson_details($user_id, 'Active');
    echo $view->mdl_update_category_lesson_data($user_id, 'Active');
