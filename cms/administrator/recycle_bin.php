...
<body class="hold-transition sidebar-collapse layout-top-nav">
  <div class="wrapper">
          ...
          <div class="card">
            ...
            <div class="card-body">
              <div class="table-responsive">
                ...
                $view = $obj->view('SystemTrashesView');
    ...
    $view = $obj->view('SystemTrashesView');
    echo $view->delete_modal('cms/administrator/recycle_bin.php', 'Active');
    echo $view->recover_modal('cms/administrator/recycle_bin.php', 'Active');
    ?>
  </div>
  <!-- ./wrapper -->
  <!-- Script -->
